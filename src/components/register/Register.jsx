...
import {FaLock, FaPhone, FaPhoneAlt, FaQuestion, FaUser} from "react-icons/fa";
...
export default function Register() {
    ...
    return (
        <div className="container d-flex justify-content-center align-items-center" style={{height: "100vh", backgroundColor: "#f0f2f5"}}>
            <div className="row">

                <div
                    className="col-md-5 d-flex justify-content-start align-items-center text-white">
                ...
                <div className="col-md-7 d-flex justify-content-end align-items-center border-left border-bottom">
                    <div className="shadow-lg p-2 rounded-4" style={{width: "700px", backgroundColor: "#ffffff"}}>
                        ...
                        <form>
                            <div className="row">
                                <div className="col mb-3">
                                    <label htmlFor="firstname" className="form-label d-flex align-items-center   ">
                                        <span className="input-group-text bg-light border-0"><FaUser /></span>Firstname
                                    </label>
                                ...
                                <div className="col mb-3">
                                    <label htmlFor="firstname" className="form-label d-flex align-items-center   ">
                                        <span className="input-group-text bg-light border-0"><FaUser /></span>Lastname
                                    </label>
                                    <div className="input-group">
                                        <Input
                                            type="text"
                            ...
                            <div className="row">
                                <div className="col mb-3">
                                    <label htmlFor="username" className="form-label d-flex align-items-center   ">
                                        <span className="input-group-text bg-light border-0"><MdEmail /></span>Mail address
                                    </label>
                                    <div className="input-group">
                                        <Input
                                            type="text"
                                ...
                                <div className="col mb-3">
                                    <label htmlFor="phone" className="form-label d-flex align-items-center   ">
                                        <span className="input-group-text bg-light border-0"><FaPhoneAlt /></span>Phone
                                    </label>
                                    <div className="input-group">
                                        <Input
                                            type="text"
                            ...
                            <div className="row p-0">
                                <label htmlFor="firstname" className="form-label d-flex align-items-center   ">
                                    <span className="input-group-text bg-light border-0 p-2"><FaQuestion /></span>Date de naissance
                                </label>
                                <div className="col mb-3">
                                    <div className="input-group">
                                        <Select
                            ...
                            <div className="col mb-3" style={{position: "relative"}}>
                                <label htmlFor="password" className="form-label d-flex align-items-center ">
                                    <span className="input-group-text bg-light border-0"><FaLock /></span>Confirm password
                                </label>
                                <div className="input-group">
                                    <Input
